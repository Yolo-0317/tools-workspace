...
video="${1:-$project_dir/exports/ep02-wind-subtitled-v01.mp4}"
...
awk -v value="$duration" 'BEGIN { exit !(value >= 21.8 && value <= 22.0) }'
ffmpeg -v error -i "$video" -f null -

echo "PASS: EP02 wind video is decodable, 720x1280, H.264/AAC, and approximately 21.9 seconds"
