...
- 0—5秒只允许正面或不超过30度的三分之四正面双角色近景；栀夏上半身占画面高度约55%—65%，阿砚占约30%—40%，两个角色合计覆盖画面约三分之二以上。
- 5秒前禁止背面、侧后方、纯侧脸、远景、纯风景、上摇离开人物或拉远展示云海星空；5秒后才允许逐步展开奇景。
...
- Create: `zhixia-feihualing/episodes/yesu-shansi/assets/scene-cards/01-ayan-frontal-close.png`
- Create: `zhixia-feihualing/episodes/yesu-shansi/assets/scene-cards/02-zhixia-frontal-close.png`
- Create: `zhixia-feihualing/episodes/yesu-shansi/assets/scene-cards/03-climb-medium.png`
...
for card in 01-ayan-frontal-close 02-zhixia-frontal-close 03-climb-medium 04-open-ending-two-shot; do
...
- 卡1：0—3.2秒阿砚提问的正面双角色近景。栀夏位于右侧，上半身占画面高度55%—65%，正脸或不超过30度三分之四正面；阿砚位于左下，占30%—40%。两人合计覆盖画面三分之二以上，木楼与低云只作背景。
- 卡2：3.2—5.0秒栀夏回应的更紧正面双角色近景。栀夏正面五官、发型与上半身服装清楚；阿砚抬头看她，双眼、双耳、额间纹样和铃铛清楚。禁止楼梯跟拍、背面或拉远。
- 卡3：5.0—9.3秒转身登楼双角色中景。摄影机从正面缓慢绕到侧面，栀夏扶栏、阿砚紧随；台阶、栏杆、立柱和楼层结构连续；阿砚边走边抬爪看逐渐显现的真实星空。
- 卡4：9.3—15.0秒露台对白与开放结尾。9.3—12.2秒保持双角色中景；12.2秒后才展开中远景，两者高度至少占画面三分之一；左侧与上方为诗句安全区；阿砚看栀夏、栀夏回看但不回答。

共同禁止：悬空塔、漂浮台阶、人物站在栏杆外、巨大月亮、极光、天宫、光门、神仙、魔法粒子、夸张银河、流星雨、角色单独出现、角色缩成小黑点、栀夏换脸或服装漂移、阿砚物种与配件漂移。卡1和卡2额外禁止背面、侧后方、超过30度侧脸、远景、纯风景、人物被裁切遮挡和镜头上摇离开面部。
...
完整写入五段动作：0—3.2秒正面近景中阿砚提问；3.2—5.0秒更紧正面近景中栀夏开始回应；5.0—6.0秒栀夏说完后才转身登楼；6.0—9.3秒双角色中景中阿砚抬爪问星星；9.3—12.2秒露台双角色中景中栀夏示意小声；12.2—15.0秒双角色中远景中阿砚回头提问且栀夏不回答。每段同时写明另一个角色的反应，禁止纯风景空镜和单角色镜头。

0—5秒写入精确摄影门禁：摄影机保持正面或不超过30度三分之四正面；栀夏上半身高度55%—65%，阿砚高度30%—40%，两人合计覆盖画面三分之二以上；不得拉远、上摇离开面部、进入侧后方、切纯侧脸或提前展示完整云海星空。5秒后才缓慢绕到侧面并逐步扩大环境尺度。

- [ ] **Step 3: 写分空间环境声提示词**

```text
0—3.2秒：开阔高山风、衣带薄纱摩擦、阿砚一次轻微爪垫落石声、极轻木檐或铜铃晃动。
3.2—5.0秒：高山风和衣料摩擦保持稳定，栀夏转身前只有极轻脚步，不提前加入密集木阶声。
5.0—9.3秒：栀夏稳步与阿砚轻快脚步分别同步木阶，榫卯低短吱响，风声进入半封闭木楼后变窄。
9.3—15.0秒：露台风声重新变宽，保留衣料和阿砚铃铛细响，山谷远端只出现一次低音量长尾寺钟；12.2秒后高山风略降，最后约0.1秒只有自然风声。
```
...
出现任一情况即整条退回Seedance重做：任一角色离开画面；0—5秒不是正面双角色近景；栀夏或阿砚人物占比不足；5秒前出现背面、侧后方、远景、拉远或上摇离开人物；角色小到不可辨认；木楼结构断裂或悬空；环境声只有音乐；缺少脚步、木阶或风声空间变化；寺钟连续敲击；出现人物原声、诗句朗诵、仙侠星空、文字或黑屏。
...
抽取0.2、1.6、3.4、4.8、5.2、6.2、7.8、9.5、11.0、12.4、13.8和14.9秒。前四个时间点必须确认：正面或不超过30度三分之四正面双角色近景；栀夏高度55%—65%；阿砚高度30%—40%；两人合计覆盖画面三分之二以上；没有背面、侧后方、纯侧脸、拉远、上摇离开面部或人物遮挡。其余时间点确认双角色同时可见、身份稳定、木楼结构连续、5秒后景别逐步展开且不存在纯风景或黑屏。

- [ ] **Step 5: 分轨试听环境声门禁**

依次试听0—3.2、3.2—5.0、5.0—9.3、9.3—15.0秒，逐项确认高山风、衣料、5秒后出现的两类脚步、木阶承重、露台空间变化和一次远钟。若任何关键声源缺失或不同步，记录失败时间点并重新生成Seedance，不下载外部音效补救。
...
抽取1.0、4.5、5.2、7.5、10.5、12.8和14.9秒：1.0与4.5秒满足前5秒正面双角色近景的人物占比和正脸门禁；5.2秒后才开始转身与展开；所有时间点两角色持续同框；对白字幕位于底部；11.5秒后完整诗句位于左侧安全区；诗句不遮挡角色；最后一帧不黑屏。分别用耳机与手机外放试听，确认五句清楚、原环境声仍具有四段空间变化、远钟只出现一次、没有诗句朗诵、最后一句与视频同步结束。
