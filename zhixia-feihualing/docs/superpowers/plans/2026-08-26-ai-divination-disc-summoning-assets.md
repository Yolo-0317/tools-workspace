...
最终检查：左侧主视图恰好六个空爻槽且完全未填充；右侧每一格也只有同样六个槽；第四格仅下三槽填入阳、阴、阴且上三槽保持空白；第五、六格的完整山雷颐自下而上为完整阳爻、断开阴爻、断开阴爻、断开阴爻、断开阴爻、完整阳爻；所有画格中的卦盘必须是同一设计；不得出现第七条线、六条固定阳爻、3D 分层、乱码文字、说明文字、Logo 或水印。
```
